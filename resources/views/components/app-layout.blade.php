...
<x-layout :title="$title">
    <div class="min-h-screen flex flex-col lg:flex-row relative overflow-x-hidden">
        ...
        <header class="lg:hidden flex items-center justify-between px-6 py-4 bg-white/80 backdrop-blur-md border-b border-slate-100 sticky top-0 z-30 w-full">
            ...
            <span class="logo-text text-xl font-black">Rateio</span>
            <div class="w-10"></div>
        </header>
        ...
        <aside id="sidebar-menu" class="fixed inset-y-0 left-0 z-50 w-72 bg-white p-8 flex flex-col gap-8 transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:flex lg:h-fit lg:m-6 lg:rounded-[2.5rem] lg:border lg:border-slate-100/80 lg:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.05)]">
            <div class="flex items-center justify-between">
                <span class="logo-text text-3xl font-black text-[#008f5d]">Rateio</span>
                <button id="sidebar-close" class="lg:hidden p-2 rounded-xl text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-all cursor-pointer" aria-label="Fechar menu">
            ...
            <nav class="flex flex-col gap-1.5">
                <a href="{{ route('home') }}" class="flex items-center gap-4 px-5 py-3.5 rounded-2xl font-bold text-sm transition-all duration-200 {{ $active === 'inicio' ? 'bg-[#e6f6f1] text-[#008f5d]' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-700' }}">
                ...
                <a href="#" class="flex items-center gap-4 px-5 py-3.5 rounded-2xl font-bold text-sm transition-all duration-200 {{ $active === 'grupos' ? 'bg-[#e6f6f1] text-[#008f5d]' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-700' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                ...
                <a href="#" class="flex items-center gap-4 px-5 py-3.5 rounded-2xl font-bold text-sm transition-all duration-200 {{ $active === 'parcelas' ? 'bg-[#e6f6f1] text-[#008f5d]' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-700' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                ...
                <a href="#" class="flex items-center gap-4 px-5 py-3.5 rounded-2xl font-bold text-sm transition-all duration-200 {{ $active === 'avisos' ? 'bg-[#e6f6f1] text-[#008f5d]' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-700' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                ...
                <a href="#" class="flex items-center gap-4 px-5 py-3.5 rounded-2xl font-bold text-sm transition-all duration-200 {{ $active === 'ajustes' ? 'bg-[#e6f6f1] text-[#008f5d]' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-700' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
